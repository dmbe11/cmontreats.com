...
<head>
	<meta charset="utf-8" />
	<title>C'MoN Checkout</title>
	<meta name="description" content="C'MoN Payment Intent" />
...
<body class="style10">
	...
	<section class="border-0 text-xl-center style17 w-auto ml-md-auto mr-md-auto">
		<div class="w-auto container-fluid">
			<div>
				<div class="col-xl-NaN col-md-NaN offset-0 col-12">
					<section class="text-md-center ml-md-auto mr-md-auto">
						<h1>2 oz Salmon Fillets</h1>
						<div>

							<h4 class="text-info">Purchase 100% Freeze Dried Salmon Fillets</h4>
							<div class="CMoN-purchase">
								<img src="../assets/img/samonBluebg.png" width="140" height="160">
							</div>
						</div>
						...
						<button id="checkoutbutton" class="style18">Buy for $<span id="total">13.00</span></button>
					</section>
	...
	<script>
      ...
      var updateQuantity = function(evt) {
        ...
        document.getElementById("total").textContent = quantity * 13.00;
